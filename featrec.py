...
def featurize_recognize(taskname):
        ...
        args = "sphinx_fe -argfile "+taskname+".featurize_args"
        ...
        args = "pocketsphinx_batch -argfile "+taskname+".recognize_args"
        audio = subprocess.Popen(shlex.split(args), stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
        retval = audio.wait()
        if retval != 0:
...
def align_extract(taskname):
        ...
        args = "/home/sravana/applications/scripts/align_extract.sh "+taskname+" "+align_hmm
...
def extract(taskname):
        ...
        args = "/home/sravana/applications/scripts/just_extract.sh "+taskname
        os.system(args)
