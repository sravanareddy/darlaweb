...
class upload:
    ...
    def POST(self): 
        ...
        if not form.validates(): #TODO: this crashes if a file was uploaded but the rest of the form didn't validate. seems to be a problem with "rendering" file inputs.
            return render.formtest(form)
        else:
            #create new task                                                               
